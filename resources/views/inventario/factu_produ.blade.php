    ...
    function cargar_medidas(){
      ...
      $.ajax({
        ...
        success: function(resp){
          ...
          let button_html = `
          <button onclick="agregar_medida_familia()" class="btn btn-success btn-sm">+</button>
          `;
            ...
            <div class="row">
              <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                <label for="medida">Nombre de la medida:</label>
                  <input type="text" name="medida" id="medida" size="20" maxlength="20" value="{{old('medida')}}" class="form-control" style="width:100%">
              </div>
              <div class="col-6 col-sm-6 col-md-6 col-lg-6">
