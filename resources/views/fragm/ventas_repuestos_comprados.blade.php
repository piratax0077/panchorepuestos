...
<table class="table table-bordered table-sm">
    <thead>
        <th width="25%" scope="col" class="letra_pequeña">FECHA</th>
        <th width="15%" scope="col" class="letra_pequeña">FACTURA</th>
        <th width="20%" scope="col" class="letra_pequeña">PRECIO COMPRA</th>
        <th width="25%" scope="col" class="letra_pequeña">PRECIO VENTA</th>
