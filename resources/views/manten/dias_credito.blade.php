@extends('plantillas.app')
  @section('titulo','Dias de Crédito - Clientes')
  @section('javascript')
    <script type="text/javascript">
      ...
      var elid=0;
        ...
        function guardar()
        {
          ...
          var url="{{url('diascredito/guardar')}}";
          if(modifica)
          {
...
<center><h2>Días de Crédito - Clientes</h2></center><br>
@endsection
...
<div class="container-fluid">
  <div id="mensajes"></div>
      <div class="row">
        ...
        <div class="col-sm-1">
          <input type="submit" name="btnGuardarDias" id="btnGuardarDias" value="Guardar" onclick="guardar()" style="margin-top: 25px" class="btn btn-info btn-sm"/>
        </div>
      </div>
    </form>
</div>
            ...
            <div class="col-md-4">
              <table class="table table-hover" height="172">
                ...
                <tr>
                  ...
                  <td>{{$dia->valor}}</td>
                  <td>
    <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="modificar({{$dia->id}},{{$dia->valor}});">Modificar</a>
                  </td>
                  <td>
    <a href="{{url('diascredito/'.$dia->id.'/borrar')}}" class="btn btn-danger btn-sm" onclick="return eliminar();">Eliminar</a>
                  </td>
                </tr>
                @endforeach
              </table>
