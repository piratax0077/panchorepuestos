...
<center><h2>Listar Repuestos</h2></center><br>
@endsection
...
@if(isset($repuestos))
    ...
    <div class="row">
        <div class="col-md-12" style="padding-right:15px;padding-left:2px;">
          <table id="tbl_repuestos" class="display compact">
            <thead>
            ...
            <td><strong><p id="precio_venta_p_{!!$repuesto->id!!}">{{$repuesto->precio_venta}}</p><input type="hidden"  id="precio_venta_{!!$repuesto->id!!}" value={!!$repuesto->precio_venta!!}></strong></td>
   ...
   <div class="modal-dialog modal-lg" role="document" >
     <div class="modal-content">
       <div class="modal-header"> <!-- CABECERA -->
        ...
        <p class="text-center" id="mod_titulo_header"></p>
...
<!-- Columna 1 : Datos -->
        <div class="col-sm-6" style="background-color: #F2F5A9;">
          <div class="row" id="datos"></div>
        </div> <!-- FIN Columna 1 : Datos -->

<!-- Columna 2 : fotos y similares -->
        <div class="col-sm-6" style="background-color: #81BEF7;">
       ...
       <button class="btn btn-default btn btn-primary btn-sm" type="button" data-dismiss="modal">Cerrar </button>
       </div>
