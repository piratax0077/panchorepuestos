...
<!-- INGRESAR/MODIFICAR CLIENTES -->
    <div class="col-sm-4" style="background-color: #e8ffff;">
      <div id="mensajes"></div>
      <div class="row">
        <h4><strong>Datos Generales:</strong></h4><br>
        ...
        <div class="col-sm-3"><button onclick="guardar_cliente()" id="btnGuardar" class="btn btn-success btn-sm">Guardar</button></div>
        <div class="col-sm-3"><button onclick="nuevo_cliente()" class="btn btn-info btn-sm">Nuevo</button></div>
        <div class="col-sm-3"><button onclick="cuenta_cliente()" class="btn btn-warning btn-sm">Cuenta</button></div>
      ...
      <div class="row">
        <div class="col-sm-10">Giro:<br><input type="text" id="giro" size="40"></div>
      </div>
      <div class="row">
        <div class="col-sm-10">Dirección:<br><input type="text" id="direccion" size="40" style="width: 323px;"></div>
      </div>
      <div class="row">
...
@else
<div class="row" style="background-color:  #66ccff; display: none;">
        <div class="col-sm-3"><input type="checkbox" id="credito_check" onclick="revisarCredito()">Crédito</div>
        <div class="col-sm-5">
          Límite:
          @if($limites->count()>0)
...
<br>
      <div class="row" style="display: none;">
        <fieldset id="zona_descuento">
            ...
            <fieldset id="zona_familia" style="display: none;width:100%">
                <div class="row" style="height:250px">
                <div class="col-sm-8" id="familia_desc" style="padding:1px">
                <p>Sin descuentos agregados</p>
                </div>
...
<!-- BUSCAR CLIENTES -->
    <div class="col-sm-8">
      ...
      <div class="row" id="listar_clientes"></div>
