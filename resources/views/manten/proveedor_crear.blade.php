      ...
      <div class="row">
        ...
        <div class="col-md-2">
            <label>Nombre Corto de la Empresa:</label>
              <input type="text" name="empresa_nombre_corto" value="{{old('empresa_nombre_corto')}}" id="empresa_nombre_corto" class="form-control" placeholder="Máximo 10 caracteres" maxlength="10">
          </div>
		<div class="col-md-3">
