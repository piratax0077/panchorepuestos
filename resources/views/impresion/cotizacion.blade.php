...
<br>
    <table>
        ...
        <tr>
            ...
            <td align="center">
                ...
                @endphp
                @if($entorno=='local')
                    <img src="file:///{{public_path('storage/imagenes/logo_pos.png')}}" width="200px" />
                @endif
                @if($entorno=='production')
                    <img src="{{asset('storage/imagenes/logo_pos.png')}}" width="200px" />
                @endif
    ...
    <table>
        <tr>
            ...
            <th scope="col" width="200px">Descripción</th>
            <th scope="col" width="20px">Precio</th>
        </tr>
        <tbody>
    ...
    <br>
    <p class="letra_chikita">{{$cab_cotizacion->nombre_cotizacion}}</p>
</body>
</html>
