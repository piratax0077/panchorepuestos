...
@section('contenido_titulo_pagina')
  <center><h2>NOTA DE CRÉDITO</h2></center>
@endsection
...
<div class="container-fluid">
  ...
  <div class="row ml-1">
    ...
    <div class="col-sm-6 col-md-6 col-lg-6" style="background-color: #66ffff;height:60%">
  ...
  <!-- COLUMNA 2 -->
  <div class="col-sm-9 col-md-9 col-lg-9" style="background-color: #ffff80;">
