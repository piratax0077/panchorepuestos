...
class Sii
{
     ...
     * @return Objeto SimpleXMLElement con la respuesta del servicio web consultado
     * @author Esteban De La Fuente Rubio, DeLaF (esteban[at]sasco.cl)
     * @version 2020-02-12
     */
...
*/
        ...
        try {
            ...
            $estado=['estado'=>'OK','mensaje'=>$xml];
            //Debugbar::info("try simpleXMLElement estado");
        } catch (\Exception $e) {
            //Log::write(Estado::ENVIO_ERROR_XML, Estado::get(Estado::ENVIO_ERROR_XML, $e->getMessage()));
            //Debugbar::warning($response);

            //Debugbar::error("Sii.php SimpleXMLElement: ".$e->getMessage());
            //Debugbar::info($response);
            $estado=['estado'=>'ERROR','mensaje'=>'XML de respuesta del SII mal formado'];
